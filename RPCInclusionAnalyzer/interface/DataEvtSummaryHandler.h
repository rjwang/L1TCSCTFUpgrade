...
struct DataEvtSummary_t {
    ...
    Int_t rpc_station[MAXPARTICLES],rpc_sector[MAXPARTICLES],rpc_cscsector[MAXPARTICLES],rpc_subsector[MAXPARTICLES],rpc_ring[MAXPARTICLES],rpc_layer[MAXPARTICLES];
